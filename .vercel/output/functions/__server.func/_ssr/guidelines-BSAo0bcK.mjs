...
//#region node_modules/.nitro/vite/services/ssr/assets/guidelines-BSAo0bcK.js
...
var SECTIONS = [
	{
		...
		body: [{ p: "Begin at age ≥35 years. Repeat every 3 years if normal. Repeat yearly if prediabetes or weight gain." }, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Pocket card"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "mt-1 font-display text-3xl tracking-tight",
				children: "ADA outpatient T2DM"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-sm leading-relaxed text-ink-soft",
				children: "Decision support in DiabCare is taken from the MGH endocrinology pocket card (ADA Standards of Care 2025–2026). Local formulary notes are added for Mbarara Regional Referral Hospital. This is not a substitute for clinical judgement."
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: SECTIONS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: s.body.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [b.h && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
